...
1. **Create a New Collection**
   ...
   ![Create Collection in Postman](images/Create-collection-postmane.png)
...
2. **Configure Performance Test**
   ...
   ![Configure Performance Test in Postman](images/Postman-Performance-tool.png)
...
3. **Run Performance Tests**
   ...
   ![Performance Test Results](images/Postman-Performance-report.png)
   ![Performance Test Results](images/Postman-performance-data.png)
